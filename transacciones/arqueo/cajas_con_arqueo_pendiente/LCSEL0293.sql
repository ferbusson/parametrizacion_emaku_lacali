...
FROM
	...
	aux_params a
WHERE
	dst.nombre IN ('FACTURACION','RECARGA TARJETAS','FCREDITO','SEPARADOS',
	'ABONOS SEPARADOS','COMPROBANTES INGRESO','CAMBIOS','DEVOLUCION VENTA',
	'DVENTA ELECTRONICA','REEMPLAZO PAGOS PARCIALES','ENTREGA BASE SENCILLA',
	'RETIRO PARCIAL','FCONTINGENCIA','FELECTRONICAPOS','FCONTINGENCIAE') AND
	dst.id_documento = ds.id_documento AND	
	ds.codigo_tipo = d.codigo_tipo AND
	d.estado AND
