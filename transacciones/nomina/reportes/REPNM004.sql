...
WHERE
	...
	c.id_clasificacion_concepto_causacion IN (54,57,55) ) -- 50:Viaticos NS 54: viaticos NS 57:Auxilios (No base salario) Oct 29 2025: se agrega 55 para tener en cuenta prima extra legal adm llamado Johana
    ) AND
	d.ndocumento=cn.ndocumento AND
	d.fecha::DATE BETWEEN an.fechai AND an.fechaf AND
	d.codigo_tipo = 'NM' AND
